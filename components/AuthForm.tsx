    ...
    return (
        <div className='flex flex-col gap-4'>
            <h1 className='text-2xl font-semibold text-white'>
                {isSignIn ? "Welcome back to Read Book" : "Create an account"}
            </h1>

            <p className='text-light-100'>
                {isSignIn
                    ? 'Access more collections and resources, and stay updated'
        ...
        <p className='text-center text-base font-medium'>
            {isSignIn ? "New to BookRead? " : "already have an account " }
